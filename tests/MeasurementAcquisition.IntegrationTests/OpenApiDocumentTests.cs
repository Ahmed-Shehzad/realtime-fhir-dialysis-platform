...
public sealed class OpenApiDocumentTests : IClassFixture<MeasurementAcquisitionApiFactory>
{
    private readonly MeasurementAcquisitionApiFactory _factory;

    public OpenApiDocumentTests(MeasurementAcquisitionApiFactory factory) =>
    ...
    public async Task OpenApi_v1_document_marks_authorized_operations_with_bearer_requirementAsync()
    {
        ...
        OpenApiBearerSecurityScan.AnyBearerRequirementListsScope(paths, "Dialysis.Measurements.Write").ShouldBeTrue();
    }
}
