...
namespace TreatmentSession.IntegrationTests;

public sealed class OpenApiDocumentTests : IClassFixture<TreatmentSessionApiFactory>
{
    private readonly TreatmentSessionApiFactory _factory;

    public OpenApiDocumentTests(TreatmentSessionApiFactory factory) =>
    ...
    public async Task OpenApi_v1_document_marks_authorized_operations_with_bearer_requirementAsync()
    {
        ...
        OpenApiBearerSecurityScan.AnyBearerRequirementListsScope(paths, "Dialysis.Sessions.Write").ShouldBeTrue();
    }
}
