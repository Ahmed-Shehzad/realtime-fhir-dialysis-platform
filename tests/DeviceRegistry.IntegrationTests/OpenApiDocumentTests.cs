...
public sealed class OpenApiDocumentTests : IClassFixture<DeviceRegistryApiFactory>
{
    private readonly DeviceRegistryApiFactory _factory;

    public OpenApiDocumentTests(DeviceRegistryApiFactory factory) =>
    ...
    public async Task OpenApi_v1_document_marks_authorized_operations_with_bearer_requirementAsync()
    {
        ...
        OpenApiBearerSecurityScan.AnyBearerRequirementListsScope(paths, "Dialysis.Devices.Write").ShouldBeTrue();
    }
}
