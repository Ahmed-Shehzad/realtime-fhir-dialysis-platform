...
public sealed class EfMeasurementValidationAuditEventStore : IAuditEventStore
{
    private readonly MeasurementValidationDbContext _db;

    public EfMeasurementValidationAuditEventStore(MeasurementValidationDbContext db) =>
