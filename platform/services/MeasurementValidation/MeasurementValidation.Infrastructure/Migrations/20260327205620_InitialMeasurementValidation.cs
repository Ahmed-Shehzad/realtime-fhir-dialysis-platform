...
namespace MeasurementValidation.Infrastructure.Migrations
{
    /// <inheritdoc />
    public partial class InitialMeasurementValidation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValidationProfileId = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    Outcome = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_validated_measurements", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_validated_measurements_MeasurementId_EvaluatedAtUtc",
                table: "validated_measurements",
