...
{
    /// <inheritdoc />
    public partial class InitialSurveillance : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_session_risk_snapshots", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_surveillance_alerts", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_session_risk_snapshots_TreatmentSessionId",
                table: "session_risk_snapshots",
                column: "TreatmentSessionId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_surveillance_alerts_TreatmentSessionId",
