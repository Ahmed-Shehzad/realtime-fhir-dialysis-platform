...
public sealed class EfRealtimeSurveillanceAuditEventStore : IAuditEventStore
{
    private readonly RealtimeSurveillanceDbContext _db;

    public EfRealtimeSurveillanceAuditEventStore(RealtimeSurveillanceDbContext db) =>
