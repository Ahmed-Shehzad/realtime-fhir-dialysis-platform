...
public sealed class ResolveSurveillanceAlertCommandHandler : ICommandHandler<ResolveSurveillanceAlertCommand>
{
    ...
    public ResolveSurveillanceAlertCommandHandler(
    ...
    public async Task HandleAsync(
        ResolveSurveillanceAlertCommand command,
        CancellationToken cancellationToken = default)
    {
        ...
        alert.Resolve(command.CorrelationId, command.ResolutionNote, _tenant.TenantId);
