...
/// <summary>
/// <see cref="IAuditEventStore"/> on the scoped <see cref="MeasurementAcquisitionDbContext"/>. Does not call <c>SaveChanges</c> —
/// commit with <see cref="IUnitOfWork"/> together with domain and outbox work.
/// </summary>
public sealed class EfMeasurementAcquisitionAuditEventStore : IAuditEventStore
{
    private readonly MeasurementAcquisitionDbContext _db;

    public EfMeasurementAcquisitionAuditEventStore(MeasurementAcquisitionDbContext db) =>
