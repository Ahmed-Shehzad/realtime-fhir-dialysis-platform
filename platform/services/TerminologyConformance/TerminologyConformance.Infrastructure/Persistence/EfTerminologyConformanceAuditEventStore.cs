...
public sealed class EfTerminologyConformanceAuditEventStore : IAuditEventStore
{
    private readonly TerminologyConformanceDbContext _db;

    public EfTerminologyConformanceAuditEventStore(TerminologyConformanceDbContext db) =>
