...
{
    /// <inheritdoc />
    public partial class InitialTerminologyConformance : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "conformance_assessments",
                columns: table => new
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    ResourceId = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    TerminologySliceOutcome = table.Column<int>(type: "integer", nullable: false),
                    ProfileSliceOutcome = table.Column<int>(type: "integer", nullable: false),
                    TerminologyReason = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    ProfileReason = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    AssessedProfileUrl = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
                    ProfileRuleRegistryVersion = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_conformance_assessments", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_conformance_assessments_ResourceId_EvaluatedAtUtc",
                table: "conformance_assessments",
                columns: new[] { "ResourceId", "EvaluatedAtUtc" });
