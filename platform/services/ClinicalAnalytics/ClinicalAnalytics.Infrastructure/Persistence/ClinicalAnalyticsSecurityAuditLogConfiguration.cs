...
internal sealed class ClinicalAnalyticsSecurityAuditLogConfiguration : IEntityTypeConfiguration<ClinicalAnalyticsSecurityAuditLogEntry>
{
    ...
    public void Configure(EntityTypeBuilder<ClinicalAnalyticsSecurityAuditLogEntry> entity)
    {
        _ = entity.ToTable("clinical_analytics_audit_log");
