...
namespace ReplayRecovery.Infrastructure.Persistence.Migrations
{
    /// <inheritdoc />
    public partial class InitialReplayRecovery : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlanCode = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    State = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    OutcomeSummary = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_recovery_plan_executions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    State = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    ProjectionSetName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    CheckpointSequence = table.Column<int>(type: "integer", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    DeletedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_replay_jobs", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "replay_recovery_audit_log",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_replay_recovery_audit_log", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_replay_recovery_audit_log_OccurredAtUtc",
                table: "replay_recovery_audit_log",
