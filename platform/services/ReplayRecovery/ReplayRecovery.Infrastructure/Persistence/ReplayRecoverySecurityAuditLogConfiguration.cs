...
internal sealed class ReplayRecoverySecurityAuditLogConfiguration : IEntityTypeConfiguration<ReplayRecoverySecurityAuditLogEntry>
{
    ...
    public void Configure(EntityTypeBuilder<ReplayRecoverySecurityAuditLogEntry> entity)
    {
        _ = entity.ToTable("replay_recovery_audit_log");
