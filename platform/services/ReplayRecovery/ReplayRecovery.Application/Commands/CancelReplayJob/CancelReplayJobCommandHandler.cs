...
public sealed class CancelReplayJobCommandHandler : ICommandHandler<CancelReplayJobCommand>
{
    ...
    public CancelReplayJobCommandHandler(
    ...
    public async Task HandleAsync(
        CancelReplayJobCommand command,
