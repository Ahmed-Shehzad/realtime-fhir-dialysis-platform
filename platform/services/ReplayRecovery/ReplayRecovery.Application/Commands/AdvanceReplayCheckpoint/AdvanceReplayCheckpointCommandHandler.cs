...
public sealed class AdvanceReplayCheckpointCommandHandler : ICommandHandler<AdvanceReplayCheckpointCommand>
{
    ...
    public AdvanceReplayCheckpointCommandHandler(
    ...
    public async Task HandleAsync(
        AdvanceReplayCheckpointCommand command,
        ...
        await _audit
            .RecordAsync(
                new AuditRecordRequest(
                    ...
                    $"Replay checkpoint advanced to {job.CheckpointSequence}.",
