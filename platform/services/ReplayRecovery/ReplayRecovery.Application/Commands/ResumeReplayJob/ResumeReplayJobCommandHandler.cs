...
public sealed class ResumeReplayJobCommandHandler : ICommandHandler<ResumeReplayJobCommand>
{
    ...
    public ResumeReplayJobCommandHandler(
    ...
    public async Task HandleAsync(
        ResumeReplayJobCommand command,
