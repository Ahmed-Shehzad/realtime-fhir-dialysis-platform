...
public sealed class EfFinancialInteroperabilityAuditEventStore : IAuditEventStore
{
    private readonly FinancialInteroperabilityDbContext _db;

    public EfFinancialInteroperabilityAuditEventStore(FinancialInteroperabilityDbContext db) =>
    ...
    public async Task<IReadOnlyList<AuditRecordRequest>> GetRecentAsync(
        int count = 100,
