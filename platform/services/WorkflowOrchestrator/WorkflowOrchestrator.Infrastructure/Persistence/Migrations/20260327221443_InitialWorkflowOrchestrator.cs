...
{
    /// <inheritdoc />
    public partial class InitialWorkflowOrchestrator : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StepOrdinal = table.Column<int>(type: "integer", nullable: false),
                    CurrentStepName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "workflow_orchestrator_audit_log",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_workflow_orchestrator_audit_log", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_workflow_instances_TreatmentSessionId",
                table: "workflow_instances",
                column: "TreatmentSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_workflow_orchestrator_audit_log_OccurredAtUtc",
                table: "workflow_orchestrator_audit_log",
