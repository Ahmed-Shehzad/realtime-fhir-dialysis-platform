...
internal sealed class WorkflowOrchestratorSecurityAuditLogConfiguration : IEntityTypeConfiguration<WorkflowOrchestratorSecurityAuditLogEntry>
{
    ...
    public void Configure(EntityTypeBuilder<WorkflowOrchestratorSecurityAuditLogEntry> entity)
    {
        _ = entity.ToTable("workflow_orchestrator_audit_log");
