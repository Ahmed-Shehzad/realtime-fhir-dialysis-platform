...
public sealed class CompleteWorkflowInstanceCommandHandler : ICommandHandler<CompleteWorkflowInstanceCommand>
{
    ...
    public CompleteWorkflowInstanceCommandHandler(
    ...
    public async Task HandleAsync(
        CompleteWorkflowInstanceCommand command,
        CancellationToken cancellationToken = default)
    {
        ...
        instance.Complete(command.CorrelationId, _tenant.TenantId);
