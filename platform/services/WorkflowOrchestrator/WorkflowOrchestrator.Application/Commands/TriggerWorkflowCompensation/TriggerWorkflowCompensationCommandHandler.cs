...
public sealed class TriggerWorkflowCompensationCommandHandler : ICommandHandler<TriggerWorkflowCompensationCommand>
{
    ...
    public TriggerWorkflowCompensationCommandHandler(
    ...
    public async Task HandleAsync(
        TriggerWorkflowCompensationCommand command,
        CancellationToken cancellationToken = default)
    {
        ...
        instance.TriggerCompensation(command.CorrelationId, command.Reason, _tenant.TenantId);
        ...
        await _audit
            .RecordAsync(
                new AuditRecordRequest(
                    ...
                    $"Compensation triggered: {command.Reason}",
