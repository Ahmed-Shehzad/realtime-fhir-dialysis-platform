...
public sealed class EfClinicalInteroperabilityAuditEventStore : IAuditEventStore
{
    private readonly ClinicalInteroperabilityDbContext _db;

    public EfClinicalInteroperabilityAuditEventStore(ClinicalInteroperabilityDbContext db) =>
