...
namespace ClinicalInteroperability.Infrastructure.Migrations
{
    /// <inheritdoc />
    public partial class InitialClinicalInteroperability : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "canonical_observation_publications",
                columns: table => new
                {
                    ...
                    FhirProfileUrl = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    State = table.Column<int>(type: "integer", nullable: false),
                    FhirResourceReference = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_canonical_observation_publications", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_canonical_observation_publications_MeasurementId_LastAttemp~",
                table: "canonical_observation_publications",
                columns: new[] { "MeasurementId", "LastAttemptAtUtc" });
