...
{
    /// <inheritdoc />
    public partial class InitialSignalConditioning : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "conditioning_results",
                columns: table => new
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    MeasurementId = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    ChannelId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    IsDropout = table.Column<bool>(type: "boolean", nullable: false),
                    DriftDetected = table.Column<bool>(type: "boolean", nullable: false),
                    QualityScorePercent = table.Column<int>(type: "integer", nullable: false),
                    ConditioningMethodVersion = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    ConditionedSignalKind = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_conditioning_results", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_conditioning_results_MeasurementId_EvaluatedAtUtc",
                table: "conditioning_results",
                columns: new[] { "MeasurementId", "EvaluatedAtUtc" });
