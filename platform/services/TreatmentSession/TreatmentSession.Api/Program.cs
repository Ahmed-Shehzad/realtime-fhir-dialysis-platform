...
_ = builder.AddRealtimePlatformObservability("TreatmentSession.Api");

_ = builder.Services.AddDialysisPlatformC5WebApi(builder.Configuration);
_ = builder.Services.AddScoped<IAuditEventStore, EfTreatmentSessionAuditEventStore>();
...
_ = builder.Services.AddDialysisPlatformMassTransit<TreatmentSessionDbContext>(builder.Configuration);
...
await app.ApplyPendingMigrationsInDevelopmentAsync<TreatmentSessionDbContext>().ConfigureAwait(false);
