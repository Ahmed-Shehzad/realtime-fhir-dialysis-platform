...
public sealed class CompleteDialysisSessionCommandHandler : ICommandHandler<CompleteDialysisSessionCommand, bool>
{
    ...
    public CompleteDialysisSessionCommandHandler(
    ...
    public async Task<bool> HandleAsync(
        CompleteDialysisSessionCommand command,
        CancellationToken cancellationToken = default)
    {
        ...
        session.Complete(command.CorrelationId, _tenant.TenantId);
        await _audit
            .RecordAsync(
