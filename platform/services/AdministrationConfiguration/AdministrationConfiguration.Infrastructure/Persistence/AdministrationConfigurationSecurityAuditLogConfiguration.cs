...
internal sealed class AdministrationConfigurationSecurityAuditLogConfiguration
    : IEntityTypeConfiguration<AdministrationConfigurationSecurityAuditLogEntry>
{
    ...
    public void Configure(EntityTypeBuilder<AdministrationConfigurationSecurityAuditLogEntry> entity)
    {
        _ = entity.ToTable("administration_configuration_audit_log");
